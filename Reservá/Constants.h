...
#define API_STORES_URL @"https://reserve.cdn-apple.com/%@/zh_%@/reserve/iPhone/stores.json"
#define API_AVAILABILITY_URL @"https://reserve.cdn-apple.com/%@/zh_%@/reserve/iPhone/availability.json"
#define RESERVATION_URL_TEMPLATE @"https://reserve-%@.apple.com/%@/zh_%@/reserve/iPhone?partNumber=%@&channel=2&rv=&path=&sourceID=&iPP=false&appleCare=&iUID=&iuToken=&carrier=&store=%@"
